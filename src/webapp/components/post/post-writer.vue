    ...
    <div class="post-writer-content">
        <div class="post-body-content">
            ...
            <div class="post-markdown-wrap">
                ...
                <mavon-editor style="height: 100%" :value="value" ref="md" @imgAdd="uploadImg" @imgDel="imgDel">
...
const qiniuUpload = async function(file ,fn){
    let tokenParam = {
        name: file.name,
        ext: file.type,
        md5: await file_md5(file)
    }
    let tokenK = await api.get('/api/img/token', tokenParam);
    // ###
