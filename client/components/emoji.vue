    ...
    <div class="j-emoji-content">
        <div class="am-tabs" data-am-tabs>
          <ul class="am-tabs-nav am-nav am-nav-tabs">
            <li class="am-active"><a href="#tab1">Emoji</a></li>
            <li><a href="#tab2">颜文字</a></li>
          ...
          <div class="am-tabs-bd">
            <div class="am-tab-panel am-active" id="tab1">
                <div class="j-emoji-box">
                    <a class="j-emoji-list j-emoji-text" v-for="item in githubEmoji[activeCategory].list" @click="$emit('selectEmoji',`:${item}:`)">
                        <img :src="path+item+ext" alt="" width="24">
                    </a>
                </div>
                <ul class="j-emoji-tab">
                    <li @click="activeCategory = index" :class="{active:activeCategory==index}" v-for="(item,index) in githubEmoji"><a>{{index}}</a></li>
                </ul>
            </div>
            <div class="am-tab-panel" id="tab2">
                <div class="j-emoji-box">
                    <a class="j-emoji-list j-emoji-text" v-for="item in emojiText" @click="$emit('selectEmoji',item)">{{item}}</a>
                </div>
                <ul class="j-emoji-tab">
