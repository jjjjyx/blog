...
class CommentDao extends db.BaseDao{
    ...
    "comment_approved",'comment_karma',"comment_agent","comment_type","comment_parent","user_id"];
    }
    async asyncInsert(data){
        ...
        sql = "INSERT INTO `myblog`.`j_comments` (`comment_post_id`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_ip`, `comment_date`, `comment_content`, `comment_agent`, `comment_parent`, `user_id`, `comment_karma`) values("+
        ":comment_post_id, :comment_author, :comment_author_email, :comment_author_url, :comment_author_ip, :comment_date, :comment_content, :comment_agent,:comment_parent, :user_id, :comment_karma)"
